 ...
 * @requires knockout
 */
define(['durandal/system', 'durandal/app', 'durandal/composition', 'durandal/activator', 'durandal/viewEngine', 'jquery', 'knockout', 'jquery-ui'], function (system, app, composition, activator, viewEngine, $, ko, jqui) {
    var contexts = {},
        dialogCount = 0,
        dialog;
    ...
    dialog = {
        ...
        close: function (obj) {
            ...
            if (theDialog) {
                ...
                $(theDialog.host).draggable("destroy");
                ...
                ensureDialogInstance(obj).then(function (instance) {
                    ...
                    dialogActivator.activateItem(instance, activationData).then(function (success) {
                        if (success) {
                            ...
                            //Goran - dodaje draggable, ako bude problema samo obrisati ove dvije linije i maknuti require na jqui
                            $(theDialog.host).draggable({ handle: ".panel-heading" });
                        } else {
                            dfd.resolve(false);
                        }
                    });
